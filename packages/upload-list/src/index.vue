<template>
  <div
    :class="[
      'tiny-mobile-upload-list',
      'tiny-mobile-upload-list--' + listType,
          ...
          >
            <img
              ...
              v-if="
                ...
                ['picture-card'].indexOf(listType) > -1
              "
              :src="file.url"
              alt=""
            />
            ...
            <div class="file-type">
              ...
              <template v-for="(item, index) in filesIcon">
                <img
                  ...
                  :src="item.url"
                  v-if="
                    filesIcon && state.screenType && file.fileType === item.type
                  "
                />
              </template>
            </div>
  ...
  >
    ...
    >
      <slot :file="file">
        ...
        <i class="tiny-icon-close-tip" v-if="!disabled">
...
import {
  renderless,
  api
} from '@opentiny/vue-renderless/upload-list/vue'
