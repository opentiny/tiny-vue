...
import { clearTimer, startTimer, close, handleAfterLeave, bindEvent, unBindEvent, destroy, watchClosed, getTypeClass, getOffsetStyle, getZindex } from './index'

export const api = ['state', 'handleAfterLeave', 'clearTimer', 'startTimer', 'close', 'getZindex']

export const renderless = (props, { computed, onBeforeUnmount, onMounted, reactive, watch }, { vm, parent, constants }) => {
  const api = {}
