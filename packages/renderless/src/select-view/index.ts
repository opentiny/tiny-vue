export const close = ({ state, emit, vm }) => () => {
  state.search.input = ''
  vm.$refs.actionSheet.close()
  emit('close', false)
}

export const watchVisible = ({ emit, state, props, api }) => (bool) => {
...
export const watchModelValue = ({ props, state, emit }) => (value) => {
...
export const selectOption = ({ emit, state, props, api }) => (data) => {
...
export const confirm = ({ state, props, api, emit }) => () => {
...
export const searchMethod = ({ state, props }) => () => {
...
export const allCheckHandler = ({ state, props }) => () => {
  state.checkList = state.checkList.length === props.menus.length ? [] : props.menus.slice()
}

export const searchSelectHandler = ({ state, emit, api, props }) => (option) => {
...
export const toggleCheckList = ({ state }) => (value) => {
...
export const clean = ({ state, props }) => () => {
...
export const selectedOptionHandler = ({ state, api }) => (option) => {
...
export const load = ({ state, props, api }) => () => {
