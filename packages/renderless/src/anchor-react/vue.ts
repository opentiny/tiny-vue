 ...
 *
 */
import type { IAnchorProps, IAnchorApi, ISharedRenderlessParamHooks, ISharedRenderlessParamUtils } from '@/types'

// export const api = ['state', 'getContainer', 'linkClick', 'setScrollContainer', 'getCurrentAnchor']
export const api = []
...
export const renderless = (
  ...
  // })
  // console.log(api, 'api renderless')
