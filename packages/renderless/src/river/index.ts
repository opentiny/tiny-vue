...
export const buildOption = ({ api, emit, props, state, vm }) => () => {
...
export const getRenderNode = ({ api: api0, echarts }) => (chartNodeData) => {
...
export const getRenderLink = ({ api, echarts }) => (chartLinkData) => {
...
export const getRenderIcon = ({ api: api0 }) => ({ chartIconData, STATUS_COLOR, STATUS_YES, STATUS_NO }) => {
  const so = api0.setRiverRgbaOpacity
...
export const getTooltip = () => ({ userTooltip, chartData }) => {
  return (params) => {
    const { data } = params
...
export const setListeners = ({ api, emit, state }) => (option) => {
...
export const setRiverRgbaOpacity = ({ props, state }) => (data, rgba) => {
  const { config } = props
...
export const lightUp = ({ api, state }) => (param) => {
...
export const style = ({ api, state }) => (param) => {
  const styl = (obj) => {
...
export const computeCanvasStyle = ({ props, state }) => () => {
...
export const resizeListener = ({ props, state }) => () => {
