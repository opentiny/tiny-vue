...
export const computedAsideStyle =
  ({ constants, props }) =>
  () => {
...
export const computedMainStyle =
  ({ constants, props }) =>
  () => {
...
export const computedFooterStyle =
  ({ constants, props }) =>
  () => {
    if (props.pattern === constants.CLASSIC) {
      return {
