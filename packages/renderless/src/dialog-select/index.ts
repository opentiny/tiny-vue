...
export const queryGridData = ({ api, props, state }) => () => {
...
export const multiGridSelectAll = ({ api, props, state }) => ({ selection, checked }) => {
  if (checked) {
...
export const multiGridSelectChange = ({ api, props, state }) => ({ row, checked }) => {
...
export const selectedBoxInit = ({ props, vm, nextTick }) => () => {
...
export const selectedBoxClear = ({ props, state, vm }) => () => {
...
export const selectedBoxDelete = ({ props, state, vm }) => ({ option: row }) => {
  const { multi, popseletor } = props
...
export const selectedBoxDrag = ({ props, state }) => ({ state: { select } }) => {
...
export const doMultiTreeFilter = ({ props, state, nextTick, vm }) => () => {
...
export const multiTreeAfterLoad = ({ api, props, state, vm }) => () => {
...
export const multiTreeFilterPlain = ({ api, props, state }) => (data) => {
  const { popseletor } = props
...
export const multiTreeLeavePlain = ({ props, state }) => (plainNode) => {
  const { popseletor } = props
...
export const multiTreeCheck = ({ api, props, state, vm, nextTick }) => () => {
  const { multi, popseletor } = props
...
export const emitChange = ({ props, state, emit }) => () => {
...
export const onFooterCancel = ({ api, props }) => () => {
  if (!props.beforeClose || props.beforeClose('cancel')) {
    api.emitClose()
  }
}

export const onFooterConfirm = ({ api, props }) => () => {
...
export const setChecked = ({ api, props, state }) => () => {
...
export const computedConfig = ({ props, state }) => () => {
...
export const doAutoLookup = ({ props, state, emit }) => () => {
...
export const multiTreeRadio = ({ api, props }) => () => {
  const { multi, popseletor } = props
...
export const multiGridRadioChange = ({ props, state }) => ({ row }) => {
