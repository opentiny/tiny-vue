...
import {
  renderless,
  api
} from '@opentiny/vue-renderless/cascader-node/vue'
...
export default {
  ...
  render() {
    ...
    const renderCheckIcon = () => {
      return <icon-yes class="tiny-cascader-node__prefix"></icon-yes>
    }

    const renderLoadingIcon = () => {
      return <icon-loading class="tiny-cascader-node__postfix"></icon-loading>
    }

    const renderExpandIcon = () => {
      return (
        <icon-chevron-right class="tiny-cascader-node__postfix"></icon-chevron-right>
      )
    }
