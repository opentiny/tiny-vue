<template>
  <div class="tiny-calendar">
    ...
    <div class="tiny-calendar__header">
      <div
        v-if="showSelected && state.selectedTip"
            ...
            >
              <template #reference>
                <div class="tiny-calendar__input">
                  <input
                    :value="state.activeYear + t('ui.datepicker.year')"
                    type="text"
                    readonly
                  />
                  <div class="tiny-calendar__input-btn">
                    <component
                      class="tiny-svg-size"
                      :is="
                        state.showYear ? 'icon-chevron-up' : 'icon-chevron-down'
                      "
                    />
                  </div>
                </div>
                ...
                <div class="tiny-calendar__selector">
                  <ul class="tiny-calendar__poplist">
                    <li
                      ...
                      :key="year"
                      :class="[
                        'tiny-calendar__list-item',
                        { 'is-selected': state.activeYear === year }
                      ]"
                      @click="
                        () => {
          ...
          <li v-show="state.displayMode === 'month'">
            ...
            >
              <template #reference>
                <div class="tiny-calendar__input">
                  <input
                    :value="t('ui.datepicker.month' + state.activeMonth)"
                    type="text"
                    readonly
                  />
                  <div class="tiny-calendar__input-btn">
                ...
                <div class="tiny-calendar__selector">
                  <ul class="tiny-calendar__poplist">
                    <li
                      ...
                      :class="[
                        'tiny-calendar__list-item',
                        { 'is-selected': state.activeMonth === month }
                      ]"
                      @click="
                        () => {
          ...
          <li>
            <Button type="primary" @click="toToday">{{
              state.displayMode === 'month'
                ...
                : t('ui.datepicker.currentMonth')
            }}</Button>
          </li>
          <li>
            <ul class="tiny-calendar__tabs">
              <li
                :class="{ active: state.displayMode === 'month' }"
                @click="toggeModel('month')"
              >
                {{ t('ui.datepicker.month') }}
              </li>
              <li
                :class="{ active: state.displayMode === 'year' }"
                @click="toggeModel('year')"
              >
              ...
              :class="[
                'tiny-calendar__day',
                {
                  selected:
                    ...
                    state.selectedDate === getTime(day.value),
                  ...
                  v-for="(
                    {
                      ...
                      title,
                      content,
                      parseTime: { year, month, day, hours, minutes }
                    },
                    j
