      ...
      <template #suffix>
        <span>
          <icon-close
            ...
            v-if="
              showClearBtn && state.commitValue && suggest && state.inputHover
            "
          ...
          <component
            v-if="
              !(showClearBtn && !!state.display && !suggest) ||
              (!suggest && !readonly)
            "
            :is="icon"
    ...
    >
      <template v-if="state.open">
        <div
          ...
          v-if="state.conditions.length && popseletor === 'grid'"
        >
        ...
        <div v-if="popseletor === 'grid'" class="tiny-popeditor-body">
          <div
            :class="[
              ...
              { 'tiny-popeditor-body__radio': !multi }
            ]"
          >
              ...
              <div class="tiny-popeditor__tabs-head">
                <ul>
                  <li
                    ...
                    :class="{
                      'tiny-popeditor__tabs-selected':
                        state.activeName === 'history'
                    }"
                  >
