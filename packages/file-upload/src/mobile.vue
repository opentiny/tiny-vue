...
import {
  renderless,
  api
} from '@opentiny/vue-renderless/file-upload/vue'
...
export default {
  ...
  render() {
    ...
    const trigger =
      (this.slots.trigger && this.slots.trigger()) || this.slots.default()

    const uploadComponent =
      !headerShow || this.listType === 'picture-card'
        ? h(Upload, { ...uploadData }, trigger)
        : ''
    ...
    return (
      ...
      >
        ...
        >
          ...
          {this.slots.trigger
            ? [uploadComponent, this.slots.default && this.slots.default()]
            : uploadComponent}
