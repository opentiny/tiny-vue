...
<button  onClick={handleClick} disabled={state.buttonDisabled || loading} type={nativeType}  a($attrs, ['class', 'style'], true) className={vc([
...
<div  className="tiny-mobile-button-loading-inner"></div>
...
<Component style={{display:icon && !loading?'block':'none'}} is={icon}  className={vc(['tiny-icon', 'is-icon', text ? 'small' : null])}></Component>
