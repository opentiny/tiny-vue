    ...
    export default function radioGroup(props) {
      const {options,modelValue,type,size,fill,textColor,disabled,vertical,displayOnly} = props
      const defaultProps = {
        ...$props,
        ...props,
        options,modelValue,type,size,fill,textColor,disabled,vertical,displayOnly
      }
...
<Component is={state.tag}   role="radiogroup" onKeydown={handleKeydown} ref={group} v-ref="group" className={vc([vertical ? 'list-inline' : ''],'tiny-radio-group')}>    
