  ...
  <div class="credit-card-item" :class="{ '-active': state.isCardFlipped }">
    <div class="credit-card-item__side -front">
      ...
      <div class="credit-card-item__cover">
        <img
          class="credit-card-item__bg"
          :src="backgroundImage || images.background"
        />
      </div>
      <div class="credit-card-item__wrapper">
        ...
        <label
          ...
          class="credit-card-item__number"
        ...
        <div class="credit-card-item__content">
          <label
            :for="fields.cardName"
            class="credit-card-item__info"
            :ref="fields.cardName"
          >
            <div class="credit-card-item__holder">Card Holder</div>
            <transition name="slide-fade-up">
              <div
                class="credit-card-item__name"
          ...
          <div class="credit-card-item__date" ref="cardDate">
            <label class="credit-card-item__dateTitle" :for="fields.cardMonth"
              >Expires</label
            >
            ...
            <label class="credit-card-item__dateItem" for="cardYear">
              <transition name="slide-fade-up">
                <span
                  ...
                  :key="labels.cardYear"
                  v-text="String(labels.cardYear).slice(2, 4)"
                ></span>
...
import {
  renderless,
  api
} from '@opentiny/vue-renderless/credit-card/vue'
