...
export default {
  ...
  props: {
    ...
    type: {
      type: String,
      validator: (value) =>
        ~['normal', 'warning', 'error', 'info', 'success'].indexOf(value)
    },
    visibleArrow: {
      type: Boolean,
      default: () => true
  ...
  render() {
                ...
                render: () => {
                  ...
                  return h('transition', propsData, [
                    <div
                      ...
                      v-show={
                        !this.disabled && this.state.showPopper && content
                      }
                      ...
                      role="tooltip"
                      aria-hidden={
                        this.disabled || !this.state.showPopper
                          ? 'true'
                          : 'false'
                      }
    ...
    const data =
      firstElement.data || firstElement.props || (firstElement.props = {})
