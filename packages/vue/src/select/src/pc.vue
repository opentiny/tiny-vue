        ...
        >
          ...
          >
            <template #suffix>
              ...
              <icon-search @click="handleQueryChange(state.query)"></icon-search>
            </template>
          </tiny-input>
...
import { iconClose, iconChevronDown, iconHalfselect, iconCheck, iconCheckedSur, iconCopy, iconSearch } from '@opentiny/vue-icon'
