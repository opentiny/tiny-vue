export const classes = {
  ...
  'select-tags':
    'absolute leading-normal whitespace-normal sm:pl-2 pr-2 z-[1] top-1/2 -translate-y-2/4 flex items-center flex-wrap [&_[data-tag=aui-tag]]:my-0.5 [&_[data-tag=aui-tag]]:h-7 [&_[data-tag=aui-tag]]:text-sm [&_[data-tag=aui-tag]]:sm:h-5 [&_[data-tag=aui-tag]]:sm:text-sm [&_[data-tag=aui-tag]_svg]:shrink-0',
