import type { RuleGroupArray, RuleGroupICArray, RuleGroupTypeAny, RuleType } from '../ts'
...
export const prepareRuleGroup = <RG extends RuleGroupTypeAny>(
  ...
  produce(queryObject, (draft) => {
    ...
    draft.rules = draft.rules.map((r) =>
      typeof r === 'string' ? r : 'rules' in r ? prepareRuleGroup(r, { idGenerator }) : prepareRule(r, { idGenerator })
