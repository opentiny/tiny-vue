<template>
  <div class="tiny-nav-menu">
    ...
    >
      <component
        :is="state.showMore ? 'IconSandwichExpand' : 'IconSandwichCollapse'"
      ></component>
    </div>
    ...
    <transition name="tiny-transition-zoom-in-top" mode="out-in">
      ...
      >
        <li v-if="state.showMore" class="more-menu">
          <ul>
            <li
              ...
              :key="index"
              :class="{ active: index === state.subActiveIndex }"
            >
              <component
                :is="getTag(item)"
                :to="getRoute(item)"
        ...
        <li
          v-if="state.subMenus && state.subMenus.length"
          :class="{ 'full-width': !state.showMore }"
          class="sub-menu"
        >
          <ul>
            <li
            ...
            >
              <ul class="group">
                <li
                  ...
                  :class="
                    !!group.title ? '' : 'tiny-nav-menu__sub-menu-title-blank'
                  "
                >
                  <component
                    :is="getTag(group)"
