export const tinyFilterBoxSmbTheme = {
  'ti-filter-box-btn-height': 'var(--ti-common-size-height-small)',
  'ti-filter-box-btn-bg-color': 'var(--ti-common-color-bg-6)',
  'ti-filter-box-btn-hover-bg-color': 'var(--ti-common-color-bg-6)',
  ...
  'ti-filter-box-help-btn-icon-color': 'var(--ti-common-color-text-primary)',
