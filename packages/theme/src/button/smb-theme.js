export const tinyButtonSmbTheme = {
  ...
  'ti-button-size-large-mini-width': 'var(--ti-common-size-31x)',
  'ti-button-size-medium-mini-width': 'var(--ti-common-size-28x)',
  'ti-button-size-normal-mini-width': 'var(--ti-common-size-24x)',
  'ti-button-size-small-mini-width': 'var(--ti-common-size-18x)',
  ...
  'ti-button-size-mini-mini-width': '24px',
  'ti-button-text-svg-width': '16px',
  'ti-button-text-svg-height': '16px',
  'ti-button-text-hover-bg-color': '#0000000D',
  'ti-button-text-hover-border-radius': '4px',
  'ti-button-text-svg-fill': '#191919',
  'ti-button-text-svg-hover-fill': '#595959',
  'ti-button-text-svg-fill-disabled': '#C2C2C2',
  ...
  'ti-button-text-size-default-min-width': '32px',
  'ti-button-text-size-default-height': '32px',
  'ti-button-text-size-default-svg-width': '24px',
  'ti-button-text-size-default-svg-height': '24px',
