  ...
  <div class="credit-card-form">
    ...
    <div class="credit-card-form__inner">
      <div class="credit-card-input">
        <label for="cardNumber" class="credit-card-input__label"
          >Card Number</label
        >
        <input
          type="tel"
      ...
      <div class="credit-card-input">
        <label for="cardName" class="credit-card-input__label"
          >Card Holder</label
        >
        <input
          type="text"
      ...
      <div class="credit-card-form__row">
        <div class="credit-card-form__col">
          <div class="credit-card-form__group">
            <label for="cardMonth" class="credit-card-input__label"
            ...
            >
              ...
              <option
                v-bind:value="$index + state.minCardYear"
                v-for="(n, $index) in 12"
                v-bind:key="n"
              >
...
import {
  renderless,
  api
} from '@opentiny/vue-renderless/credit-card-form/vue'
