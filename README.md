...
- The [element](https://github.com/ElemeFE/element) project which is an old Vue.js-based component library. TinyVue refers to Element at the beginning of its design, and is compatible with the component API of Element.
...
- [@adamwathan](https://github.com/adamwathan)'s article [Renderless Components in Vue.js](https://adamwathan.me/renderless-components-in-vuejs/), which inspired TinyVue's renderless component design architecture and finally realized cross-end and cross-framework capabilities in the TinyVue project.
