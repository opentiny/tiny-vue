...
var CustomElement = /* @__PURE__ */ function(_HTMLElement) {
  ...
  _proto.connectedCallback = function connectedCallback() {
    var image = "/static/images/button-image.png";
    ReactDOM.createRoot(this).render(/* @__PURE__ */ React.createElement(Button, null, /* @__PURE__ */ React.createElement("img", {
      src: image,
      width: "26"
    }), /* @__PURE__ */ React.createElement("span", null, "图片按钮")));
  };
