...
import { B as Button } from "../index-3d3bc6e4.mjs";
...
import { I as IconEdit, a as IconDel } from "../index-8a8089e8.mjs";
...
function App() {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("style", null, '\n          [data-v="' + scopeId + '"] .title {\n            font-size: 16px;\n            margin-top: 10px;\n            margin-bottom: 14px;\n            font-weight: bold;\n          }\n          [data-v="' + scopeId + '"] .tiny-row {\n            margin-bottom: 20px;\n          }\n          [data-v="' + scopeId + '"] .tiny-button {\n            margin-bottom: 10px;\n            margin-left: 0;\n            margin-right: 8px;\n          }\n        '), /* @__PURE__ */ React.createElement("div", {
    "data-v": scopeId
  }, /* @__PURE__ */ React.createElement(Layout, null, /* @__PURE__ */ React.createElement(Row, null, /* @__PURE__ */ React.createElement("div", {
    className: "title"
  }, "常规按钮尺寸："), /* @__PURE__ */ React.createElement(Button, {
    size: "large"
  }, "超大按钮"), /* @__PURE__ */ React.createElement(Button, {
    size: "medium"
  }, "中等按钮"), /* @__PURE__ */ React.createElement(Button, {
    size: "small"
  }, "小型按钮"), /* @__PURE__ */ React.createElement(Button, null, "默认按钮"), /* @__PURE__ */ React.createElement(Button, {
    size: "mini"
  }, "超小按钮")), /* @__PURE__ */ React.createElement(Row, null, /* @__PURE__ */ React.createElement("div", {
    className: "title"
  }, "朴素按钮尺寸："), /* @__PURE__ */ React.createElement(Button, {
    type: "primary",
    size: "large",
    plain: true
  }, "超大按钮"), /* @__PURE__ */ React.createElement(Button, {
    ...
    className: "title"
  }, "圆角按钮尺寸："), /* @__PURE__ */ React.createElement(Button, {
    type: "success",
    size: "large",
    round: true
  }, "超大按钮"), /* @__PURE__ */ React.createElement(Button, {
    ...
    className: "title"
  }, "圆形按钮尺寸："), /* @__PURE__ */ React.createElement(Button, {
    type: "warning",
    size: "large",
    icon: IconEdit,
    circle: true
    ...
    className: "title"
  }, "纯图标按钮尺寸："), /* @__PURE__ */ React.createElement(Button, {
    icon: IconDel,
    type: "text",
    size: "large"
  }), /* @__PURE__ */ React.createElement(Button, {
