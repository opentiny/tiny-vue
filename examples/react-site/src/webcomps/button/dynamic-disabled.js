...
import { u as useVm, a as useSetup, v as vc, I as If, b as Slot, B as Button } from "../index-3d3bc6e4.mjs";
...
import { I as IconSearch } from "../index-5e90c4f6.mjs";
...
function pc(props) {
  var _constants = props._constants, _props$disabled = props.disabled, disabled = _props$disabled === void 0 ? false : _props$disabled, showText = props.showText, falseColor = props.falseColor, _props$falseValue = props.falseValue, falseValue = _props$falseValue === void 0 ? false : _props$falseValue, _props$mini = props.mini, mini = _props$mini === void 0 ? false : _props$mini, _props$modelValue = props.modelValue, modelValue = _props$modelValue === void 0 ? false : _props$modelValue, size = props.size, _props$tabindex = props.tabindex, tabindex = _props$tabindex === void 0 ? "1" : _props$tabindex, trueColor = props.trueColor, _props$trueValue = props.trueValue, trueValue = _props$trueValue === void 0 ? true : _props$trueValue, beforeChange = props.beforeChange, _props$displayOnly = props.displayOnly, displayOnly = _props$displayOnly === void 0 ? false : _props$displayOnly, onChange = props.onChange;
  ...
  }), state = _useSetup.state, toggle = _useSetup.toggle;
  return /* @__PURE__ */ React.createElement("span", {
    ...
    className: state.innerClasses
  }, /* @__PURE__ */ React.createElement(If, {
    "v-if": !mini && state.showText
  }, /* @__PURE__ */ React.createElement(Slot, {
    "v-if": state.currentValue === trueValue,
    name: "open",
    slots: props.slots
  }, "ON"), /* @__PURE__ */ React.createElement(Slot, {
    "v-if": state.currentValue === falseValue,
    name: "close",
    slots: props.slots
  }, "OFF"))));
}
...
function Switch(props) {
  var _ref = props || {}, _ref$tiny_mode = _ref.tiny_mode, tiny_mode = _ref$tiny_mode === void 0 ? "pc" : _ref$tiny_mode, _ref$_constants = _ref._constants, _constants = _ref$_constants === void 0 ? $constants : _ref$_constants;
  var defaultProps = Object.assign({
    _constants,
    tiny_mode
  }, props);
...
function App() {
  var _useState = useState(false), disabled = _useState[0], setDisabled = _useState[1];
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("style", null, '\n          [data-v="' + scopeId + '"] .tiny-row {\n            margin-bottom: 20px;\n          }\n          [data-v="' + scopeId + '"] .tiny-button {\n            margin-bottom: 10px;\n            margin-left: 0;\n            margin-right: 8px;\n          }\n        '), /* @__PURE__ */ React.createElement("div", {
    "data-v": scopeId
  }, /* @__PURE__ */ React.createElement(Layout, null, /* @__PURE__ */ React.createElement(Row, null, "是否禁用：", /* @__PURE__ */ React.createElement(Switch, {
    checked: disabled,
    ...
    type: "danger",
    disabled
  }, "危险按钮")), /* @__PURE__ */ React.createElement(Row, null, /* @__PURE__ */ React.createElement(Button, {
    disabled,
    plain: true
    ...
    disabled,
    ghost: true
  }, "幽灵按钮"), /* @__PURE__ */ React.createElement(Button, {
    icon: IconSearch,
    disabled
  }, "图标按钮"), /* @__PURE__ */ React.createElement(Button, {
    icon: IconSearch,
    disabled
