<template>
  <tiny-grid ref="gridRef" :data="tableData" seq-serial show-overflow="ellipsis">
...
<script setup>
import { ref } from 'vue'
import { Grid as TinyGrid, GridColumn as TinyGridColumn, Input, Select, Button as TinyButton } from '@opentiny/vue'
