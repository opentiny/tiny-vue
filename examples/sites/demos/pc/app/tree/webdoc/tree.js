  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          'Using the <code>props</code> property, specify the <code>label/children/disabled/isLeaf</code> mapping. To enable users to pass data in a non-standard format to the <code> data </code> property. <br>\n          <code>disabled</code> Specifies the disabled status of a node. <br>\n          <code>isLeaf</code> Specifies whether the node is a leaf node and is valid only for lazy loading. <br>\n        '
      },
      codeFiles: ['props.vue']
    },
    {
