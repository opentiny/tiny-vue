<template>
  <tiny-grid
    :keyboard-config="keyboardConfigData"
    :data="tableData"
    seq-serial
    height="200"
...
export default {
  ...
  data() {
    return {
      keyboardConfigData: {
        isArrow: true, // 是否开启方向键功能，默认 false
        isDel: true, // 是否开启删除键功能，默认 false
        isTab: true, // 是否开启 Tab 键功能，默认 false
        isEdit: true, // 是否开启任意键进入编辑（功能键除外），默认 false
        editMethod({ seq }) {
