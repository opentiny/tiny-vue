  ...
  demos: [
    {
      ...
      'desc': {
        'zh-CN': `<p>通过 <code>#default</code> 添加表格列的默认插槽。</p>`,
    ...
    },
    {
      ...
      'desc': {
        'zh-CN': `<p>通过 <code>#toolbar</code> 添加表格的工具栏插槽。</p>`,
        'en-US': 'For details, see the following example.'
      },
    ...
    },
    {
      ...
      'desc': {
        'zh-CN': `<p>通过 <code>#empty</code> 添加表格的空数据插槽。</p>`,
        'en-US': 'For details, see the following example.'
      },
    ...
    },
    {
      ...
      'desc': {
        'zh-CN': `<p>通过 <code>#header</code> 添加表格列的表头插槽。</p>`,
        'en-US': 'For details, see the following example.'
      },
