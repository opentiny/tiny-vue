export default {
  ...
  demos: [
    ...
    },
    {
      ...
      'desc': {
        'zh-CN':
          '<p>走马灯指示器默认显示在幻灯片内容上，配置 <code>indicator-position</code> 为<code>outside</code>后，将显示在外部。\n配置 <code>trigger</code> 为<code>click</code>，可以修改指示器触发方式为单击，默认鼠标悬停到指示器时，走马灯幻灯片就会对应切换。</p>\n',
        'en-US':
    ...
    },
    {
      ...
      'desc': {
        'zh-CN':
          '<p>配置 <code>loop</code> 属性为<code>false</code>后，若走马灯幻灯片已切换到最后一项，则将不能再从第一项开始循环切换。即切换到最后一项时，右侧切换箭头不再显示，切换到第一项时，左侧切换箭头不再显示。</p>\n',
        'en-US':
    ...
    },
    {
      ...
      'desc': {
        'zh-CN': '<p>配置 <code>autoplay</code> 属性为<code>true</code>后，走马灯的幻灯片内容将自动轮播切换。</p>\n',
        'en-US':
    ...
    },
    {
      ...
      'desc': {
        'zh-CN': '<p>配置 <code>type</code> 属性为<code>vertical</code>即可实现纵向轮播。</p>\n',
    ...
    },
    {
      ...
      'desc': {
        'zh-CN': '<p>配置 <code>type</code> 属性为<code>card</code>后，走马灯将以卡片形式进行展示。</p>\n',
        'en-US':
