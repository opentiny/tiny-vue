export default {
  ...
  demos: [
    ...
    {
      'demoId': 'candle-demo2',
      'name': { 'zh-CN': 'K 线图显示 MA', 'en-US': 'K-line chart shows MA' },
      'desc': { 'zh-CN': '详细用法参考如下示例', 'en-US': 'For details, see the following example.' },
      'codeFiles': ['candle/demo2.vue']
    },
    {
      'demoId': 'candle-demo3',
      'name': { 'zh-CN': 'K 线图显示 volume', 'en-US': 'K-line chart shows volume' },
      'desc': { 'zh-CN': '详细用法参考如下示例', 'en-US': 'For details, see the following example.' },
      'codeFiles': ['candle/demo3.vue']
    },
    {
      'demoId': 'candle-demo4',
      'name': { 'zh-CN': ' K 线图显示 dataZoom', 'en-US': 'K-line chart shows dataZoom' },
      'desc': { 'zh-CN': '详细用法参考如下示例', 'en-US': 'For details, see the following example.' },
      'codeFiles': ['candle/demo4.vue']
    },
    {
      'demoId': 'candle-demo5',
      'name': { 'zh-CN': '不显示 volume 调整位置', 'en-US': 'Do not display the volume adjustment position' },
      'desc': { 'zh-CN': '详细用法参考如下示例', 'en-US': 'For details, see the following example.' },
      'codeFiles': ['candle/demo5.vue']
    },
    {
      'demoId': 'candle-demo6',
      'name': { 'zh-CN': '显示 volume 调整位置', 'en-US': 'Displaying the volume adjustment position' },
      'desc': { 'zh-CN': '详细用法参考如下示例', 'en-US': 'For details, see the following example.' },
