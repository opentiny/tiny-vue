  ...
  demos: [
    {
      ...
      'name': { 'zh-CN': '父元素的初始宽度未知 1', 'en-US': 'The initial width of the parent element is unknown2' },
      'desc': {
        'zh-CN':
          '<p>在一个初始宽度未知的容器内绘制图表时，因为无法获取宽度，所以图表会绘制失败，解决的办法是在容器宽度已知后，\n调用 echarts 的 resize 方法。\n通过 <code>cancel-resize-check</code> 是用于 resize 之前，检测组件元素是否存在，元素是否有宽高，没有则不 resize。</p>\n',
        'en-US':
    ...
    },
    {
      ...
      'name': { 'zh-CN': '父元素的初始宽度未知 2', 'en-US': 'The initial width of the parent element is unknown 2.' },
      'desc': {
    ...
    },
    {
      ...
      'name': { 'zh-CN': '小数显示精度 1', 'en-US': 'Decimal display precision1' },
      'desc': {
        'zh-CN':
    ...
    },
    {
      ...
      'name': { 'zh-CN': '小数显示精度 2', 'en-US': 'Decimal display precision2' },
      'desc': {
