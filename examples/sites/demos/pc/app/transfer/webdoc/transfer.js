      ...
      'properties': [
        {
          ...
          'type': 'Array',
          'defaultValue': '[]',
          'desc': { 'zh-CN': '左右列表的全量数据源', 'en-US': 'Transfer data source' },
          'demoId': 'basic-usage'
        },
        {
          ...
          'type': 'Array',
          'defaultValue': '[]',
          'desc': { 'zh-CN': '移动到右列表的数据项的key的数组值', 'en-US': 'Bound Value' },
          'demoId': 'basic-usage'
        },
        {
          'name': 'filterable',
        ...
        },
        {
          ...
          'type': 'object',
          'defaultValue': '',
          'desc': { 'zh-CN': '数据源的字段别名映射配置', 'en-US': 'Field alias of the data source' },
          'demoId': 'custom-render'
        },
        {
        ...
        },
        {
          ...
          'type': 'boolean',
          'defaultValue': 'false',
          'desc': { 'zh-CN': '是否展示全部移动按钮', 'en-US': 'All Move Buttons' },
          'demoId': 'custom-btns'
        },
        {
          'name': 'drop-config',
