<template>
  <tiny-tabs v-model="activeName">
    <tiny-tab-item name="first">
      <template #title>
        <div>
          <tiny-icon-calendar style="vertical-align: middle" class="tiny-svg-size"></tiny-icon-calendar>
          <span>表单组件</span>
        </div>
      </template>
    ...
    <tiny-tab-item name="second">
      <template #title>
        <div>
          <tiny-icon-replies style="fill: red; vertical-align: middle" class="tiny-svg-size"></tiny-icon-replies>
          <span>数据组件</span>
        </div>
      </template>
