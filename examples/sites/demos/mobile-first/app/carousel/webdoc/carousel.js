  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>The walk indicator is displayed on the slide by default. If `indicator-position` is set to outside, the indicator is displayed outside.<br />If `trigger` is set to click, you can change the indicator triggering mode to click. By default, when you hover the mouse over the indicator, the slideshow is switched accordingly.</p>'
      },
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>Invoke the `setActiveItem()`, `next()`, and `prev()` methods to perform NVOD as required. The `initial-index` property specifies the slide index that is initially activated.</p>'
      },
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>After the `loop` attribute is set to false, if the slide is switched to the last item, the slide cannot be switched cyclically from the first item. That is, when switching to the last item, the right toggle arrow is no longer displayed, and when switching to the first item, the left toggle arrow is no longer displayed.</p>'
      },
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>After the `autoplay` attribute is set to true, the slide content of the walking lantern is automatically switched in rotation.</p>'
      },
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>The default interval is 3000 ms. You can customize the interval by using the `interval` attribute.</p>'
      },
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>The `aspect-ratio` attribute is used to set the aspect ratio of the carousel. If height is set, height is used as the primary value. The default value is 16:2. You can set any integer aspect ratio. After `aspect-ratio` is set, the height of the carousel is automatically adjusted according to the set scale when the page is zoomed in or out.</p>'
      },
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>The `indicator-style` attribute can be used to set the indicator style of the carousel chart. The options are light and dark. The default value is light.</p>'
      },
