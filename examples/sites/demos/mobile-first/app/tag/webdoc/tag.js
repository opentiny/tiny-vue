  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>You can use `hit` to set the label border. The options are true and false. The default value is false.</p>'
      },
      codeFiles: ['hit.vue']
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>You can use `size` to set the tag size. The value can be medium, small, or mini. The default value is medium.</p>'
      },
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>You can use `effect` to set the tag theme. The value can be dark, light, or plain. The default value is light. <br>`type`You can set the corresponding type for the tag. The value can be (success / warning / alerting / error / default / info). The default value is info.</p>'
      },
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>Click `+ New Tag` and enter the name of the tag you want to define in the text box to create a tag in the last tag list.</p>'
      },
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>You can use `theme` to set labels of other colors. Currently, the new color labels include pink, purple, and cyan.</p>'
      },
