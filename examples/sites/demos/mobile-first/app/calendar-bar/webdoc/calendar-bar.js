export default {
  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>使用 cascaderPosition 属性可以改变年月选择的位置；可选值为：<code>start | center | end</code> 默认值为<code>center</code><p>',
        'en-US':
