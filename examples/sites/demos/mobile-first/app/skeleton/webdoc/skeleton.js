export default {
  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过<code>style</code> 可自定义样式结构。</p>\n',
        'en-US': '<p>Customize style structure through<code>style</code>.</p>\n'
      },
    ...
    {
      demoId: 'image-item-slot',
      name: {
        'zh-CN': '自定义图像',
        'en-US': 'Custom image'
      },
      desc: {
        'zh-CN': '<p>通过 <code>variant="image"</code> 的默认插槽自定义图像。</p>\n',
        'en-US': '<p>Use the default slot of <code>variant="image"</code> to customize the image.</p>\n'
      },
      codeFiles: ['image-item-slot.vue']
    }
  ]
}
