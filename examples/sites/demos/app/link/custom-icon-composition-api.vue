<template>
  <div>
    <tiny-link>
      <template #icon>
        <tiny-icon-fillet-external-link class="tiny-svg-link"></tiny-icon-fillet-external-link>
      </template>
      链接按钮
    </tiny-link>
    ...
    <tiny-link disabled>
      <template #icon>
        <tiny-icon-fillet-external-link class="tiny-svg-size"></tiny-icon-fillet-external-link>
      </template>
      链接按钮
    </tiny-link>
    ...
    <tiny-link :underline="false">
      <template #icon> <tiny-icon-del class="tiny-svg-size"></tiny-icon-del> </template> 删除
    </tiny-link>
  </div>
</template>
