<template>
  <div>
    <div style="padding: 10px">
      <tiny-button @click="setHeight(200)">修改200px</tiny-button>
      <tiny-button @click="setHeight(400)">修改400px</tiny-button>
      <tiny-button @click="setHeight(600)">修改600px</tiny-button>
    </div>
...
function setHeight(heightSize) {
  height.value = { height: heightSize + 'px' }
}
</script>
