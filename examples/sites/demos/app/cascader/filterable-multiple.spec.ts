...
test('多选可搜索', async ({ page }) => {
  ...
  await page.goto('http://localhost:7130/pc/cascader/filterable-multiple')
  await page.getByPlaceholder('试试搜索：安装').nth(1).click()
  await page.getByPlaceholder('试试搜索：安装').nth(1).fill('安装')
