          ...
          <div class="tip-ctn">
            ...
            <div class="tip-container">
              ...
              >
                ...
                <span>
                  <Reverse class="tip-element-icon" v-if="item.iconPath === 'Vertical'" />
                </span>
                <span>
...
.icon-wrapper {
  padding: 9px; /* (32-14)/2 = 9px，使总尺寸为32×32 */
  margin: 0 6px; /* 调整间距，因为padding已经占了空间 */
