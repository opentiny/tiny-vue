      ...
      <div class="ti-f-r ti-f-pos-between ti-f-box-end ti-pb20">
        ...
        <div>
          <tiny-tooltip placement="top" :append-to-body="false" :content="copyTip">
            <i :class="copyIcon" class="h:c-success ti-w16 ti-h16 ti-cur-hand" @click="copyCode(demo)"
              @mouseout="resetTip()" />
          </tiny-tooltip>
          <tiny-tooltip placement="top" :append-to-body="false"
            :content="demo.isOpen ? i18nByKey('hideCode') : i18nByKey('showCode')">
            <i :class="!!demo.isOpen ? 'i-ti-codeslash' : 'i-ti-code'"
              class="ti-ml8 h:c-success ti-w16 ti-h16 ti-cur-hand" @click="toggleDemoCode(demo)" />
          </tiny-tooltip>
  ...
  setup(props) {
    ...
    const fn = {
      ...
      openPlayground(demo, open = true) {
        ...
        const url = `${import.meta.env.VITE_PLAYGROUND_URL}?cmpId=${cmpId}&fileName=${demo.codeFiles[0]
