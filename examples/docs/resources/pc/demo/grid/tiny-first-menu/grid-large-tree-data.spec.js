...
test('树表虚拟滚动', async ({ page }) => {
  ...
  await page.goto('http://localhost:7130/pc/grid-large-data/tiny-first-menu-grid-large-tree-data')
  // 展开树表
  await page.getByRole('cell', { name: 'IR-1-120个子US' }).locator('i').click()
