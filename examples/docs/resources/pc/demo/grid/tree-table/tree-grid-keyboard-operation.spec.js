...
test('树表高亮键盘操作', async ({ page }) => {
  ...
  await page.goto('http://localhost:7130/pc/grid-tree-grid/tree-table-tree-grid-keyboard-operation')
  await page.getByRole('row', { name: '3 TGBYX公司 华南区 360' }).locator('i').click()
  await page.getByRole('row', { name: '5 YHN科技YX公司 华南区 810' }).locator('i').click()
