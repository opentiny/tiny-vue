<template>
  <div>
    <tiny-button @click="click">setActiveCell</tiny-button>
    <tiny-button @click="click1">setActiveRow</tiny-button>
    <tiny-grid :data="tableData" ref="grid" border :edit-config="{ trigger: 'click', mode: 'cell', showStatus: true }">
      <tiny-grid-column type="index" width="60"></tiny-grid-column>
      <tiny-grid-column type="selection" width="60"></tiny-grid-column>
      <tiny-grid-column field="employees" :editor="{ component: 'input', autoselect: true }" title="员工数"></tiny-grid-column>
...
export default {
  ...
  methods: {
    click() {
      this.$refs.grid.setActiveCell(this.tableData[0], 'employees')
    },
    click1() {
      this.$refs.grid.setActiveRow(this.tableData[1])
    },
