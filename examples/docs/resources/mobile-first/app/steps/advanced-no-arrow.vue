<template>
  <tiny-steps ref="steps" advanced no-arrow :data="data" :active="advancedActive" @click="advancedClick"></tiny-steps>
</template>
  ...
  data() {
    return {
      ...
      data: [
        ...
        { name: '默认 Billing2', status: '', description: '默认无状态2' },
        { name: '默认 Billing3', status: '', description: '默认无状态3' },
        { name: '默认 Billing4', status: '', description: '默认无状态4' }
      ]
    }
  },
  methods: {
