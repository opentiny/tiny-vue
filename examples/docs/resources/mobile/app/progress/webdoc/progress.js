export default {
  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过设置<code>width</code>属性设置环形进度条画布宽度（只在type 为 circle 或 dashboard 时可用）。</p>',
        'en-US': '<p>button click</p>',
      },
      codeFiles: ['width.vue'],
    },
      ...
      properties: [
        {
          ...
          defaultValue: '',
          desc: {
            'zh-CN': '<p>进度条背景色（会覆盖 status 状态颜色）</p>',
            'en-US': 'Is fixed top',
          },
          demoId: 'custom-color',
        },
        {
          ...
          defaultValue: '',
          desc: {
            'zh-CN': '<p>显示文字内置在进度条内时，用于自定义显示内容</p>',
        ...
        },
        {
          ...
          defaultValue: '',
          desc: {
            'zh-CN': '<p>进度条显示文字内置在进度条内（只在 type=line 时可用）</p>',
        ...
        },
        {
          ...
          defaultValue: '',
          desc: {
            'zh-CN': '<p>环形进度条画布宽度（只在 type 为 circle 或 dashboard 时可用）</p>',
            'en-US': 'width',
          },
          demoId: 'width',
        },
