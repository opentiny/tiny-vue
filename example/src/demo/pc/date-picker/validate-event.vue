<template>
  <tiny-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
    ...
    <tiny-form-item label="活动时间" required>
      <tiny-col :span="12">
        <tiny-form-item prop="date1">
          <tiny-date-picker :validate-event="false" type="date" placeholder="选择日期" v-model="ruleForm.date1" style="width: 100%"></tiny-date-picker>
        </tiny-form-item>
      </tiny-col>
      <tiny-col :span="12">
        <tiny-form-item prop="date2">
          <tiny-time-picker :validate-event="false" placeholder="选择时间" v-model="ruleForm.date2" style="width: 100%"></tiny-time-picker>
        </tiny-form-item>
      </tiny-col>
    </tiny-form-item>
    <tiny-form-item>
