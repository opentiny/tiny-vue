<template>
  <div>
    ...
    >
      ...
      <tiny-grid-column field="city" title="城市(级联子级)" :editor="{ component: CustomSelect, attrs: attrs }"></tiny-grid-column>
    </tiny-grid>
  </div>
</template>
...
export default {
  ...
  methods: {
    activeMethod({ column, row }) {
      if (column.property === 'city') {
        this.attrs.data = getCascadeData({
          type: 'city',
