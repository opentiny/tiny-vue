<template>
  <div>
    <tiny-grid :data="tableData">
      ...
      <tiny-grid-column field="name" title="自定义列渲染" :renderer="renderName"></tiny-grid-column>
      <tiny-grid-column field="boole" title="Vue 渲染器" align="center" :renderer="{ component: Switch }"></tiny-grid-column>
