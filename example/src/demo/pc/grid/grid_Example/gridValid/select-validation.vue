<template>
  <div>
    <tiny-grid :data="tableData" ref="basicGrid" :edit-config="{ trigger: 'click', mode: 'cell', showStatus: true }" :edit-rules="validRules">
      <template #toolbar>
...
export default {
  ...
  methods: {
    toolbarButtonClickEvent({ code }) {
      switch (code) {
        case 'selectData': {
          let selectRecords = this.$refs.basicGrid.getSelectRecords()
