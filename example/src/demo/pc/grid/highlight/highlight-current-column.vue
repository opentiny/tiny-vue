<template>
  <tiny-grid ref="highlightgrid" :data="tableData" highlight-current-column :highlight-hover-row="false">
    <template #toolbar>
      <tiny-grid-toolbar>
        <template #buttons>
          <tiny-button @click="cancelHighlightColumn" title="手动取消当前高亮列" style="margin-bottom: 20px">手动取消当前高亮列</tiny-button>
        </template>
      </tiny-grid-toolbar>
    </template>
...
<script>
import { Grid, GridColumn, Button, GridToolbar } from '@opentiny/vue'
