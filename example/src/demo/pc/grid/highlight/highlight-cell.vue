<template>
  ...
  >
    ...
    <tiny-grid-column field="name" title="公司名称" :editor="{ component: 'input', autoselect: true }"></tiny-grid-column>
    <tiny-grid-column field="employees" title="员工数" :editor="{ component: 'input', autoselect: true }"></tiny-grid-column>
    <tiny-grid-column field="created_date" title="创建日期" :editor="{ component: 'input', autoselect: true }"></tiny-grid-column>
    <tiny-grid-column field="city" title="城市" :editor="{ component: 'input', autoselect: true }"></tiny-grid-column>
  </tiny-grid>
</template>
