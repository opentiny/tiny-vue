<template>
  <tiny-grid :data="tableData" :sort-config="{ trigger: 'cell' }">
    ...
    <tiny-grid-column field="employees" title="员工数(员工数和名称组合排序)" sortable :sort-by="['employees', 'name']" show-header-overflow></tiny-grid-column>
    <tiny-grid-column field="created_date" title="创建日期(时间和名称组合排序)" sortable :sort-by="['time', 'name']" show-header-overflow></tiny-grid-column>
