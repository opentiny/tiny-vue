<template>
  <tiny-grid :data="tableData" :sort-config="{ trigger: 'cell' }" @toolbar-button-click="toolbarButtonClickEvent">
    <template #toolbar>
    ...
    <tiny-grid-column field="employees" title="员工数排序点击表头排序，可以通过配置 trigger 设置触发源" sortable show-header-overflow></tiny-grid-column>
