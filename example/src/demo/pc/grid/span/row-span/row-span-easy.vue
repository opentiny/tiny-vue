<template>
  <tiny-grid setting :row-span="renderOp" :select-config="{ checkMethod: handleCheckMethod }" seq-serial :data="tableData">
...
export default {
  ...
  data() {
    return {
      ...
      renderOp: [{ field: 'area' }, { field: 'province' }]
    }
  },
  methods: {
    handleCheckMethod({ row }) {
