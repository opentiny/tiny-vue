...
const FunctionalComponent = {
  functional: true,
  componentName: 'MyFunctionalComponent',
  props: {
    row: Object,
    column: Object
  },
  render(c, context) {
    if (!flag) {
      isvue3 = this && this.$options && this.$options.componentName === 'MyFunctionalComponent'
      isvue2 = context && context.props
      flag = true
    }

    const props = isvue3 ? this : isvue2 ? context.props : {}
    const { row, column } = props
    const data = context.data || {}

    if (!row || !column) return null

    return h('div', data, row[column.property])
  }
}
...
const template = {
  ...
  prior: '中',
  microServ: 'MS012601',
  designOwner: '435259704104388',
  iterate: '八月版本迭代一',
  requireProposer: '435259704104388',
  healthStatus: '正常',
  devOwner: '435259704104388',
  testOwner: '435259704104388',
  currentOwner: '435259704104388',
