<template>
  <tiny-grid :data="tableData" resizable :edit-config="{ trigger: 'click', mode: 'cell', showStatus: true }">
    ...
    <tiny-grid-column :title="renderHeaderDescription" header-align="center">
      ...
      <tiny-grid-column field="area" :title="renderHeaderArea" :editor="{ component: 'select', options: options }" sortable></tiny-grid-column>
    </tiny-grid-column>
    <tiny-grid-column :title="renderHeaderRelation" header-align="center">
      <tiny-grid-column field="address" :title="renderHeaderAddress" :editor="{ component: 'input', autoselect: true }" sortable></tiny-grid-column>
      <tiny-grid-column
        field="introduction"
        title="公司简介"
