        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              url: '',
              children: [
                { title: 'Area 片区', url: '#/zh-CN/component/area' },
                { title: 'Company 公司', url: '#/zh-CN/component/company' },
                { title: 'Dept 部门', url: '#/zh-CN/component/dept' },
                { title: 'eDoc 企业文档', url: '#/zh-CN/component/Edoc' },
                { title: 'User 用户', url: '#/zh-CN/component/user' }
              ]
            }
          ]
        },
