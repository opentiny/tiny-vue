<template>
  <tiny-tabs v-model="activeName" activeColor="blue" :swipeable="true">
    ...
    <tiny-tab-item title="标签6" name="sixth"> 内容6 </tiny-tab-item>
    <tiny-tab-item title="标签7" name="seventh"> 内容7 </tiny-tab-item>
  </tiny-tabs>
</template>
