  ...
  <div class="demo-form">
    ...
    <div class="demo-form-position-padds">
      <tiny-form ref="ruleForm" :model="createData" :rules="rules" label-width="100px" label-position="left">
        <tiny-form-item label="你真的好优秀呀！" prop="users">
          <tiny-input v-model="createData.users" vertical placeholder="请输入内容" type="form"></tiny-input>
        </tiny-form-item>
        <tiny-form-item label="你真的好优秀呀！" prop="users" ellipsis>
          <tiny-input v-model="createData.user" vertical placeholder="请输入内容" type="form"></tiny-input>
        </tiny-form-item>
